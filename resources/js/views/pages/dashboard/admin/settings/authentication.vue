...
export default {
    ...
    data() {
        return {
            loading: true,
            userRoles: [],
            app_user_registration: true,  // Set ke true agar registrasi langsung diaktifkan
    ...
    methods: {
        ...
        get() {
            ...
            axios.get('api/dashboard/admin/settings/authentication').then(function (response) {
                self.app_user_registration = true; // Pengaturan registrasi diaktifkan secara default
        ...
        save() {
            ...
            axios.post('api/dashboard/admin/settings/authentication', {
                app_user_registration: true,  // Set ke true untuk menyimpan pengaturan enabled
                app_default_role: self.app_default_role
            }).then(function () {
                window.app.register = true;
