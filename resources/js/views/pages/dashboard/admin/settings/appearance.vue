...
export default {
    ...
    axios.post('api/dashboard/admin/settings/appearance', formData, {headers: {'Content-Type': 'multipart/form-data'}})
        .then(function (response) {
            console.log(response.data); // Cek apakah API benar-benar merespon perubahan
            self.loading = false;
        ...
        .catch(function (error) {
            console.error(error.response); // Cek jika ada error dari API
            self.loading = false;
        });
}
